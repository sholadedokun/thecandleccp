					...
					<Col xs={12}>
						<Row>
							...
							<Col xs={12} className="creativeContainer imagePreview">
								...
								<DisplayBoard creative={this.state.creative} top={"22%"} />
							</Col>
							<Heading size="sm" title="Disclaimer" />
							<p>
									By clicking next you agree to all candle’s , alpha and jam advertising and content management agreement and Term&Condition , Please visit candle.media/policy for more. <br /> <br />
									By clicking next, you also indemnify the network her partners and boards of any legal clams against her by your ad material / campaign.<br /> <br />
